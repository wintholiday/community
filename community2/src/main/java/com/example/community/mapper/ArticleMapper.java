...
public interface ArticleMapper {
    //发布文章
    @Update("INSERT INTO `Article` (`userId`, `title`, `date`, `content`) VALUES (#{userId}, #{title}, #{date}, #{content});")
    void insertArticle(int userId,String title,String date,String content);
    ...
    //通过文章id查询文章
    @Select("SELECT `userId`,`title`,`date`,`content` FROM Article WHERE articleId = #{articleId}; ")
